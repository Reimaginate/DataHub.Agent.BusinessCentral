...
[BusinessCentralUrl("purchaseReceiptLines")]
[BusinessCentralParentUrl("purchaseReceipts", nameof(DocumentId))]
public sealed class PurchaseReceiptLine : BusinessCentralDocument
{
    ...
    [JsonProperty("expectedReceiptDate"), JsonPropertyName("expectedReceiptDate"), BusinessCentralDate]
    public string? ExpectedReceiptDate { get => GetAttributeValue<string>("expectedReceiptDate"); set => SetWithNotification("expectedReceiptDate", value); }
}
