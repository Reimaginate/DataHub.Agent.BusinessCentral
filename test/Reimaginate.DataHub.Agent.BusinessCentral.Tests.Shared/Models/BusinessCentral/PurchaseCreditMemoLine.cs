...
[BusinessCentralUrl("purchaseCreditMemoLines")]
[BusinessCentralParentUrl("purchaseCreditMemos", nameof(DocumentId))]
public sealed class PurchaseCreditMemoLine : BusinessCentralDocument
{
    ...
    [JsonProperty("itemId"), JsonPropertyName("itemId")]
    public Guid? ItemId { get => GetAttributeValue<Guid?>("itemId"); set => SetWithNotification("itemId", value); }
    ...
    [JsonProperty("unitCost"), JsonPropertyName("unitCost")]
    public decimal? UnitCost { get => GetAttributeValue<decimal?>("unitCost"); set => SetWithNotification("unitCost", value); }

    [JsonProperty("discountAmount"), JsonPropertyName("discountAmount")]
    [BusinessCentralPatchDependency("quantity", "unitCost")]
    ...
    [JsonProperty("amountExcludingTax"), JsonPropertyName("amountExcludingTax")]
    public decimal? AmountExcludingTax { get => GetAttributeValue<decimal?>("amountExcludingTax"); set => SetWithNotification("amountExcludingTax", value); }
    ...
    [JsonProperty("amountIncludingTax"), JsonPropertyName("amountIncludingTax")]
    public decimal? AmountIncludingTax { get => GetAttributeValue<decimal?>("amountIncludingTax"); set => SetWithNotification("amountIncludingTax", value); }
}
