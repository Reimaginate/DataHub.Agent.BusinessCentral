...
[BusinessCentralUrl("salesQuoteLines")]
[BusinessCentralParentUrl("salesQuotes", nameof(DocumentId))]
public sealed class SalesQuoteLine : BusinessCentralDocument
{
    ...
    {
        get => GetAttributeValue<decimal?>("netAmount");
        set => SetWithNotification("netAmount", value);
    }
    ...
    {
        get => GetAttributeValue<decimal?>("netTaxAmount");
        set => SetWithNotification("netTaxAmount", value);
    }
    ...
    {
        get => GetAttributeValue<decimal?>("netAmountIncludingTax");
        set => SetWithNotification("netAmountIncludingTax", value);
    }
}
