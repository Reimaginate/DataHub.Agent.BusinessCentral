...
[BusinessCentralUrl("salesCreditMemoLines")]
[BusinessCentralParentUrl("salesCreditMemos", nameof(DocumentId))]
public sealed class SalesCreditMemoLine : BusinessCentralDocument
{
    ...
    {
        get => GetAttributeValue<string>("shipmentDate");
        set => SetWithNotification("shipmentDate", value);
    }
}
