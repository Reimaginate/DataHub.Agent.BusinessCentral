...
[BusinessCentralUrl("dimensionValues")]
[BusinessCentralLastModified("lastModifiedDateTime")]
public sealed class FinancialDimensionValue : BusinessCentralDocument, IBusinessCentralIncrementalEntity
{
    ...
    [JsonProperty("dimensionId"), JsonPropertyName("dimensionId")]
    public Guid? DimensionId { get => GetAttributeValue<Guid?>("dimensionId"); set => SetWithNotification("dimensionId", value); }
