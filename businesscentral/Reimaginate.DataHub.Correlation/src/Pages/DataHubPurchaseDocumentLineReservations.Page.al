page 71013 "Data Hub Purchase Line Res."
{
    PageType = API;
    APIPublisher = 'reimaginate';
    APIGroup = 'dataHub';
    APIVersion = 'v1.0';
    EntityName = 'purchaseDocumentLineReservation';
    EntitySetName = 'purchaseDocumentLineReservations';
    ...
    var
        ...
        DocumentRequiredErr: Label 'documentId %1 does not identify a Business Central purchase order.';
